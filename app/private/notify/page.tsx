...
import { Bell, Send, Loader2, ArrowLeft } from "lucide-react"
                    ...
                    <Card className="dark:bg-gray-800 dark:border-gray-700">
                        <CardHeader className="text-center pb-2">
                            <motion.div
                                ...
                                className="inline-flex items-center justify-center w-16 h-16 bg-yellow-400/10 rounded-full mb-4 mx-auto"
                            >
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        className="bg-gray-50 dark:bg-gray-700/50 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white"
                                    />
                                    {errors.bookingId && (
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.driverEmail && (
                                        <p className="text-red-500 text-sm mt-1">{errors.driverEmail.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.driverNumber && (
                                        <p className="text-red-500 text-sm mt-1">{errors.driverNumber.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.carName && (
                                        <p className="text-red-500 text-sm mt-1">{errors.carName.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {errors.carPlateNumber && (
                                        <p className="text-red-500 text-sm mt-1">{errors.carPlateNumber.message}</p>
                                    )}
                                </div>
